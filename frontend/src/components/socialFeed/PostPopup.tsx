  ...
  const renderVideoPreview = useCallback(() => {
    return (
      <div className="flex  flex-col ">
        ...
        {/* Title Input */}
        <div className="border border-gray-100 shadow-sm  rounded-lg p-3 mb-4 mt-4">
      ...
      if(postType === "Post"){
        ...
        const promise = async () => {
          try {
            ...
            const { data: postData } = await axios.post(`https://128i1lirkh.execute-api.ap-south-1.amazonaws.com/dev/publish-post/${userId}`, {
              title : postTitle,
        ...
        const promise = async () => {
          try {
            ...
            const { data: postData } = await axios.post(`https://128i1lirkh.execute-api.ap-south-1.amazonaws.com/dev/ask-question/${userId}`, {
              title : postTitle,
              description : postContent,
              urgency : false,
              anonymous : false,
      ...
      try {
        ...
        if (file.size < 10000000) {
          ...
          try{
            ...
            //   "https://128i1lirkh.execute-api.ap-south-1.amazonaws.com/dev/generate-presigned-url",
            //   {
            //     fileName: file.name,
            //     uploadId: uploadId,
            //     partNumbers: numChunks,
            ...
            const { data: postData } = await axios.post(`https://128i1lirkh.execute-api.ap-south-1.amazonaws.com/dev/create-reel/${userId}`, {
