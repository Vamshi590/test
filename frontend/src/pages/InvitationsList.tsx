      ...
      try {
        ...
        const formattedData = data.map(
          (user: {
            ...
            name: user.name,
            profession: user.department || "Unknown", // Replace with your backend field for profession
                  ...
                  {invitations
                    ...
                    <div className="col-span-12 md:col-span-6">
                       <InvitationCard
                        ...
                        handleProfileClick={() => handleProfileclick("8")}
                        isFollowing={false}
                      />
                    </div>
                      ...
                      .map((person, index) => (
                        <div className="col-span-12 md:col-span-6 lg:col-span-4">
                          <InvitationCard
                            ...
                            handleProfileClick  = {() => handleProfileclick(person.id)}
                          />
                        </div>
                      ))}
                  </div>
